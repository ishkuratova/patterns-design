...
from models.observable_repository import ObservableEmployeeRepository
...
class OrganizationController:
    ...
    def _initialize_repositories(self):
        ...
        for org_id, org_config in self.organizations.items():
            ...
            observable_repo = ObservableEmployeeRepository(repo)
            
            self._repositories[org_id] = repo
            self._observable_repositories[org_id] = observable_repo
    ...
    def get_observable_repository(self, organization_id):
        """Получение наблюдаемого репозитория по ID организации"""
        return self._observable_repositories.get(organization_id)
